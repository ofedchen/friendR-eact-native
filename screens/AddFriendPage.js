...
import { ActivityIndicator, Alert, Image, KeyboardAvoidingView, Platform, SafeAreaView, ScrollView, StyleSheet, Text, TextInput, ToastAndroid } from "react-native";
...
export default function AddFriendPage() {
    ...
    const saveFriend = async () => {
        ...
        try {
            ...
            if (response.ok) {
                if (Platform.OS === "android")
                    ToastAndroid.show("Friend saved!", ToastAndroid.SHORT);
                else
                    Alert.alert("Success", "Friend saved!");
                setFriendName(null);
                setAddress(null);
                setBirthday(null);
                setImage(null);
                ...
                if (Platform.OS === "android")
                    ToastAndroid.show("Failed to save friend.", ToastAndroid.SHORT);
                else
